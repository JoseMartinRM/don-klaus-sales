...
def setup_don_klaus_funnel():
    ...
    camp_lead_magnet = {
        ...
        "keywords": "reglas, regla, klaus, don klaus, quiero, quiero las reglas, pdf, guia, guía, info, informacion, información, dinero, sistema, frases, frias, frías, libro, libreta, consejo, consejos, enviar, enviamelo, envíamelo, link, enlace, acceso, pasamelo, pásamelo, me interesa",
        "match_mode": "contains",
        "post_id_filter": "",
        "public_replies": [
